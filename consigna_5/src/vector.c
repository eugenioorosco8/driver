...
/*==================[inclusions]=============================================*/
#include "mi_nuevo_proyecto.h"
//#include "TimerDriver.h"

/*==================[macros and definitions]=================================*/
extern void MyRITimerISR(void);
extern void MyEocAdcISR(void);
...
void (* const g_pfnVectors[])(void) = {
   ...
   MyRITimerISR,      /* 0x1b 0x0000006C - No Handler set for ISR RIT (IRQ 11) */
   ...
   MyEocAdcISR,      /* 0x21 0x00000084 - No Handler set for ISR ADC0 (IRQ 17) */
